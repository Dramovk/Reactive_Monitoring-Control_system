...
void loop() {
  ...
  switch(state)
  {
    ...
    case 2:
    {
      fan_Speed=80;
      outlet_Opening=10;
      // multiplier This is a weird state, 
      // the multiplier is really only for the automatic mode...
      break;
    }
  }
}
...
/*// automatic - do all automatic stuff
      ...
      if(interval){ // 1 second interval
        ...
        if(fanCount==600){
          ...
          else if (dryerState==1){
            dryerState=2;
            fan_Speed=75;
          }
          else if (dryerState==2){
            dryerState=3;
            outlet_Opening=40;
          }
          else if (dryerState==3){
            dryerState=4;
            outlet_Opening=0;
          }
          else if (dryerState==4){
            dryerState=0;
            outlet_Opening=20;
            fan_Speed=50;
          }
